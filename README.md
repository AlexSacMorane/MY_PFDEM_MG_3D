...
### DEM
The goal of the DEM step is to compute a steady-state configuration. Grains are modeled with level set functions. The shape is computed from an interpolation of the phase variable.
